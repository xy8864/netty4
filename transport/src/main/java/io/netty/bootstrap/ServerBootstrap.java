...
public final class ServerBootstrap extends AbstractBootstrap<ServerBootstrap, ServerChannel> {
    ...
    /**
     * <pre>
     * 		Netty4中习惯相互称呼为 parent-child。比如下边参数中的parentGroup-childGroup.
     * 		但是我这边的开发习惯实际上是一个boss-worker的关系。
     * 
     * 		分析ServerBootstrap & AbstractBootstrap得知。
     * 		boss线程组对象是在AbstractBootstrap中的。
     * 		worker线程组对象是在ServerBootstrap中的。
     * </pre>
     * 
    ...
    public ServerBootstrap group(EventLoopGroup parentGroup, EventLoopGroup childGroup) {
        ...
        // 返回已经设置后的ServerBootstrap。保证了下边的链式方法调用。
        return this;
    }
